...
- La homologacion amplia de ramas economicas ya fue implementada en `data/analysis-data/2026-07-10_afip_ganancias_sociedades_tidy_homologado.csv`. Conserva codigos originales y etiquetas originales en el diccionario de actividad; agrega rama comun amplia y no equipara directamente codigos de 3 digitos entre clasificadores.
