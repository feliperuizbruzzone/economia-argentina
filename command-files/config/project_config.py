...
ANALYSIS_CREATION_DATE = "2026-07-10"
...
GANANCIAS_SOCIEDADES_TIDY_HARMONIZED_PATH = (
    ANALYSIS_DATA_DIR
    / f"{ANALYSIS_CREATION_DATE}_afip_ganancias_sociedades_tidy_homologado.csv"
)
...
GANANCIAS_SOCIEDADES_VARIABLE_DICTIONARY_PATH = (
    AFIP_INTERMEDIATE_DATA_DIR
    / f"{ANALYSIS_CREATION_DATE}_afip_ganancias_sociedades_variable_dictionary.csv"
)
